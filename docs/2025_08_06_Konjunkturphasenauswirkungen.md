...
- [ ] MODIFIER: lebenshaltungskostenMultiplier (Modifier)
- [ ] MODIFIER: bildungUndKarriereCostModifier
- [ ] MODIFIER: sozialesUndFreizeitCosModifier
- [ ] MODIFIER: bonuseinkommen -> gehaltModifier
- [ ] MODIFIER: Kreditsperre - Modifier analog zu Investitionssperre
- [ ] MODIFIER: 50% Chance, dass Rezession folgt -> Modifier
...
- [ ] BildungUndKarriereCost
- [ ] SozialesUndFreizeitCost
- [ ] LebenshaltungskostenMultiplier (Konjunkturphase)
- [ ] Kreditsperre
- [ ] IncreasedChanceForRezession
