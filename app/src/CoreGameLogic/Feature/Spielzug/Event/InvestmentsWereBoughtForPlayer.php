...
class InvestmentsWereBoughtForPlayer implements GameEventInterface, ProvidesResourceChanges, ProvidesInvestmentPriceChanges, ZeitsteinAktion, ProvidesInvestmentAmountChanges
{
    /**
