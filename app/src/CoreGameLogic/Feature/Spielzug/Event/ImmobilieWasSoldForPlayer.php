...
class ImmobilieWasSoldForPlayer implements GameEventInterface, ProvidesResourceChanges, ZeitsteinAktion, DrawsCard
{
    /**
     ...
     * @param ImmobilienType $immobilienType
     * @param CardId $immobilieSold
     */
    public function __construct(
        ...
        public ImmobilienType  $immobilienType,
        public CardId          $immobilieSold,
    )
    {
    }
    ...
    public static function fromArray(array $values): GameEventInterface
    {
        return new self(
            ...
            immobilienType: ImmobilienType::from($values['immobilienType']),
            immobilieSold: CardId::fromString($values['immobilieSold']),
        );
    }
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            'immobilienType' => $this->immobilienType->value,
            'immobilieSold' => $this->immobilieSold->value,
        ];
    }
