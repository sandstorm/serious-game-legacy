...
final readonly class SpielzugCommandHandler implements CommandHandlerInterface
{
    public function canHandle(CommandInterface $command): bool
    {
        return $command instanceof AcceptJobOffer
            ...
            || $command instanceof SellInvestmentsAfterPurchaseForPlayer
    ...
    public function handle(CommandInterface $command, GameEvents $gameEvents): GameEventsToPersist
    {
        ...
        return match ($command::class) {
            ...
            SellInvestmentsAfterPurchaseForPlayer::class => $this->handleSellInvestmentsAfterPurchase($command, $gameEvents),
    ...
    /**
     * @param SellInvestmentsAfterPurchaseForPlayer $command
     * @param GameEvents $gameEvents
     * @return GameEventsToPersist
     */
    private function handleSellInvestmentsAfterPurchase(SellInvestmentsAfterPurchaseForPlayer $command, GameEvents $gameEvents): GameEventsToPersist
    {
