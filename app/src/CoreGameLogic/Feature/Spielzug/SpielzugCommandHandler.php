...
use Domain\CoreGameLogic\Feature\Spielzug\Aktion\DiscardCardAktion;
...
final readonly class SpielzugCommandHandler implements CommandHandlerInterface
{
    public function canHandle(CommandInterface $command): bool
    {
        return $command instanceof AcceptJobOffer
            ...
            || $command instanceof DiscardCard;
    }
    ...
    public function handle(CommandInterface $command, GameEvents $gameEvents): GameEventsToPersist
    {
        ...
        return match ($command::class) {
            ...
            DiscardCard::class => $this->handleDiscardCard($command, $gameEvents),
        };
    }
    ...
    /**
     * @param DiscardCard $command
     * @param GameEvents $gameEvents
     * @return GameEventsToPersist
     */
    private function handleDiscardCard(DiscardCard $command, GameEvents $gameEvents): GameEventsToPersist
    {
        $aktion = new DiscardCardAktion($command->categoryId);
        return $aktion->execute($command->playerId, $gameEvents);
    }
}
