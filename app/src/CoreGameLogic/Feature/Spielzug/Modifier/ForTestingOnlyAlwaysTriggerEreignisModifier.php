...
readonly final class ForTestingOnlyAlwaysTriggerEreignisModifier extends Modifier
{
    public function __construct(
        ...
        parent::__construct(ModifierId::FOR_TESTING_ONLY_ALWAYS_TRIGGER_EREIGNIS, $playerTurn, $description);
    }
    ...
    {
        return $hook === HookEnum::FOR_TESTING_ONLY_ALWAYS_TRIGGER_EREIGNIS;
    }
