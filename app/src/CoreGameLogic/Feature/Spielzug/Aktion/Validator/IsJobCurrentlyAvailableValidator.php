...
final class IsJobCurrentlyAvailableValidator extends AbstractValidator
{
    ...
    {
        $currentJobOffers = PileState::getFirstThreeCardsFromPile($gameEvents, new PileId(CategoryId::JOBS, PlayerState::getCurrentLebenszielphaseIdForPlayer($gameEvents, $playerId)));
