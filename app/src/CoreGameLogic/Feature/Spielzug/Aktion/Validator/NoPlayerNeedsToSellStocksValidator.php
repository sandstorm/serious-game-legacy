 ...
 */
final class NoPlayerNeedsToSellStocksValidator extends AbstractValidator
{
    public function validate(GameEvents $gameEvents, PlayerId $playerId): AktionValidationResult
    {
        ...
        if (
            ...
            return new AktionValidationResult(
                canExecute: false,
                reason: 'Du kannst deinen Spielzug nicht beenden. Andere Spieler können noch Aktien verkaufen.'
            );
        }
