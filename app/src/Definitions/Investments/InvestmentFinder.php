...
class InvestmentFinder
{
    ...
    public static function getAllInvestments(): array
    {
        ...
        $etfMcsiWorld = new InvestmentDefinition(
            ...
            description: "Ein weltweiter Indexfonds, der über 1 500 Blue-Chip-Aktien bündelt und somit eine breite Diversifikation ermöglicht und Einzelrisiken reduziert.",
            longTermTrend: 7,
            fluctuations: 15,
            jumpPerYear: 0,
            jumpSize: 0,
