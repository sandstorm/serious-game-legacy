...
/**
 * Insurances are paid in advance for either the current year (the year in which you take out the insurance) or the
 * upcoming year (at the end of a Konjunkturphase)
 */
