...
describe('getLoansForPlayer', function () {
    ...
    it('returns existing loans', function () {
        ...
        expect($loans)->toHaveCount(1)
            ...
            ->and($loans[0]->interestRate->value)->toEqual(5)
            ->and($loans[0]->getRepaymentAmount()->value)->toEqual(12500)
            ->and($loans[0]->getRepaymentAmountPerRound()->value)->toEqual(625)
            ->and(MoneySheetState::getSumOfAllLoans($gameEvents, $this->players[0])->value)->toEqual(10000);
