...
<div @class([
    ...
    @if ($drawEmpty)
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 19 17" aria-hidden="true">
            <g>
        ...
        <span class="sr-only">Leere Freizeitkompetenz</span>
    @else
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 19 17" aria-hidden="true">
            <g>
        ...
        <span class="sr-only">Eine Freizeitkompetenz</span>
    @endif
</div>
