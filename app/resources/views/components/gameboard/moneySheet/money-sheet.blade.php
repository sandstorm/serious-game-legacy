...
<div class="moneysheet">
    <div @class(["moneysheet__income", $this->getButtonPlayerClass()])>
        <table>
            <thead>
            <tr>
    ...
    <div @class(["moneysheet__expenses", $this->getButtonPlayerClass()])>
        <table>
            <thead>
            <tr>
            ...
            <tr>
                <td wire:click="showExpensesTab('{{ ExpensesTabEnum::TAXES }}')">Steuern und Abgaben
            ...
            <tr>
                <td wire:click="showExpensesTab('{{ ExpensesTabEnum::LIVING_COSTS }}')">Lebenshaltungskosten
