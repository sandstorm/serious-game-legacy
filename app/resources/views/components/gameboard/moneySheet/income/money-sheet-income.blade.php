...
<div class="tabs">
    <ul role="tablist" class="tabs__list">
        <li @class(['tabs__list-item', 'tabs__list-item--active' => $this->activeTabForIncome === IncomeTabEnum::INVESTMENTS])>
            <button id="investments" type="button" class="button" role="tab" wire:click="$set('activeTabForIncome', '{{ IncomeTabEnum::INVESTMENTS }}')">
        ...
        <li @class(['tabs__list-item', 'tabs__list-item--active' => $this->activeTabForIncome === IncomeTabEnum::SALARY])>
            <button id="salary" type="button" class="button" role="tab" wire:click="$set('activeTabForIncome', '{{ IncomeTabEnum::SALARY }}')">
                Gehalt
            </button>
        </li>
    </ul>
