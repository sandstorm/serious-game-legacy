...
@section('content')
    <h2>Jobangebote</h2>
    <p>Hier kannst du dir die Jobangebote anschauen, die dir zur Verfügung stehen. Du kannst dich für einen Job entscheiden, wenn du mindestens 1 Zeitstein in der Kategorie "Erwerbseinkommen" hast.</p>
    <div class="job-offers">
        @foreach($jobOffers as $jobOffer)
            <div class="job-offers__item">
                ...
                <hr />
                <button type="button" class="button button--type-primary" wire:click="applyForJob({{ $jobOffer->id }})">Das mache ich!</button>
            </div>
        @endforeach
    </div>
@endsection
