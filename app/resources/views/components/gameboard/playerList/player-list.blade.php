...
<div x-data="playerList()" x-trap.noscroll="open" @touchstart="touchStart($event)" @touchend="touchEnd()"
    @class([
        'player-list',
    ])
    :class="open ? 'player-list--show-details' : ''"
>
    ...
    @foreach($players as $player)
        ...
        >
            <button type="button" title="Spielerübersicht öffnen/schließen" class="button button--type-borderless" x-on:click="open = !open">
            ...
            <div class="player-list__player-details" x-cloak x-show="open">
