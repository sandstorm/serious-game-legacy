...
use Domain\CoreGameLogic\Feature\Spielzug\Aktion\SellInvestmentsAfterPurchaseForPlayerAktion;
...
use Domain\CoreGameLogic\Feature\Spielzug\Event\InvestmentsWereSoldAfterPurchaseForPlayer;
...
trait HasInvestitionen
{
    ...
    public function renderingHasInvestitionen(): void
    {
        ...
        // TODO also show modal if another player has sold investments this turn
        if (GamePhaseState::anotherPlayerHasBoughtOrSoldInvestmentsThisTurn($this->getGameEvents(), $this->myself) &&
    ...
    {
        $aktion = new SellInvestmentsAfterPurchaseForPlayerAktion(
            $investmentId,
            InvestmentPriceState::getCurrentInvestmentPrice($this->getGameEvents(), $investmentId),
    ...
    public function sellInvestmentsAfterPurchase(string $investmentId): void
    {
        ...
        $this->coreGameLogic->handle($this->gameId, SellInvestmentsAfterPurchaseForPlayer::create(
            $this->myself,
            $investmentId,
        ...
        /** @var InvestmentsWereSoldAfterPurchaseForPlayer $event */
        $event = $this->getGameEvents()->findLast(InvestmentsWereSoldAfterPurchaseForPlayer::class);
