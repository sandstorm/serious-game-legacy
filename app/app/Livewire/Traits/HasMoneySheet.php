...
trait HasMoneySheet
{
    ...
    private function resetTakeOutALoanForm(): void
    {
        ...
        $this->takeOutALoanForm->zinssatz = KonjunkturphaseState::getCurrentKonjunkturphase($this->getGameEvents())->getAuswirkungByScope(AuswirkungScopeEnum::LOANS_INTEREST_RATE)->modifier;
    }
