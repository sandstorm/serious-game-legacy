...
use App\Livewire\Dto\PlayerZeitstein;
...
class PlayerList extends Component
{
    ...
    private function getPlayers(): array
    {
        ...
        foreach ($orderedPlayers as $playerId) {
            $playerList[] = new PlayerListDto(
                ...
                playerId: $playerId,
                playerColor: PlayerState::getPlayerColorClass($this->gameEvents, $playerId),
                playersTurn: $playerId->equals($this->activePlayer),
    ...
    private function getZeitsteineForPlayer(PlayerId $playerId): array
    {
        ...
        for ($i = 0; $i < $initialZeitsteine; $i++) {
            ...
            $zeitstein = new PlayerZeitstein($isAvailable);
