...
class KonjunkturphaseSellInvestmentsToAvoidInsolvenz extends Component
{
    /**
    ...
    public function render(): View
    {
        ...
        return view('components.konjunkturphase.konjunkturphase-sell-investments-to-avoid-insolvenz-modal', [
