...
Feature: Testcase for Download Component
    ...
    Scenario: Download rendering
        ...
        Then in the fusion output, the inner HTML of CSS selector ".download" matches '<span class="icon-arrow-down-to-line download__icon" aria-hidden="true"></span><span>Download button<span class="download__size">(1 MB)</span></span>'
