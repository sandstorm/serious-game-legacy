...
Feature: Testcase for Social Media Icons Component
    ...
    Scenario: Social media icons integration component gets link from start page setting
        When I render the Fusion object "/testcase" with the current context node:
            ...
            """
        Then in the fusion output, the inner HTML of CSS selector ".social-media-icons" matches '<a target="_blank" href="https://www.facebook.de" aria-label="Facebook" class="social-media-icons__link"><i class="icon-facebook"></i></a>'
    ...
    Scenario: Social media icons rendering
        When I render the Fusion object "/testcase" with the current context node:
            ...
            """
        Then in the fusion output, the inner HTML of CSS selector ".social-media-icons" matches '<a target="_blank" href="https://www.instagram.de" aria-label="Instagram" class="social-media-icons__link"><i class="icon-instagram"></i></a><a target="_blank" href="https://www.facebook.de" aria-label="Facebook" class="social-media-icons__link"><i class="icon-facebook"></i></a><a target="_blank" href="https://www.twitter.de" aria-label="Twitter" class="social-media-icons__link"><i class="icon-twitter"></i></a><a target="_blank" href="https://www.youtube.de" aria-label="YouTube" class="social-media-icons__link"><i class="icon-youtube"></i></a>'
    ...
    Scenario: Social media icons rendering only mastodon
        When I render the Fusion object "/testcase" with the current context node:
            ...
            """
        Then in the fusion output, the inner HTML of CSS selector ".social-media-icons" matches '<a target="_blank" href="https://www.mastodon.de" aria-label="Mastodon" class="social-media-icons__link"><i class="icon-mastodon"></i></a>'
